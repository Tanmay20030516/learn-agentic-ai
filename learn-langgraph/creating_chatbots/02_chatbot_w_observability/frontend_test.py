...
def stream_with_delay(stream: Iterator[dict[Any, Any] | Any], delay: float=0.05) -> Generator:
    ''' streams the messages with a simulated delay '''
...
def init_chat_state():
    ''' initializes chatbot with the system prompt '''
    st.session_state["chatbot"].invoke(initial_state)
