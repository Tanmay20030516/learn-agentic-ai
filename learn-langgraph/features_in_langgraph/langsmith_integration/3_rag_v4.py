...
load_dotenv()
os.environ["LANGSMITH_PROJECT"] = "rag-chatbot-v4"

PDF_PATH = "learn-langgraph/09_langsmith/langsmith-masterclass/islr.pdf"  # change to your file
...
def setup_pipeline_and_query(
    ...
    return chain.invoke(
        question,
        config={"run_name": "rag_w_local_indexing", "tags": ["qa"], "metadata": {"k": 4}}
    )
